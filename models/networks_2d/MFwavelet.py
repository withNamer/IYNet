...
class Fusion_Attention_M2(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        x = x.permute(1, 0, 2, 3, 4)  # 奇怪，我为什么需要permute呢？
...
#         self.R_Conv1 = conv_block(ch_in=in_channels, ch_out=32*2)
#         self.R_Conv2 = conv_block(ch_in=32*2, ch_out=64*2)
#         self.R_Conv3 = conv_block(ch_in=64*2, ch_out=128*2)
#         self.R_Conv4 = conv_block(ch_in=128*2, ch_out=256*2)
#         self.R_Conv5 = conv_block(ch_in=256*2, ch_out=512*2)

#         self.RS_Up5 = up_conv(ch_in=512*2, ch_out=256*2)
#         self.RS_Up_conv5 = conv_block(ch_in=int(512/2) + 256*4*2, ch_out=256*2)
#         self.RS_Up4 = up_conv(ch_in=256*2, ch_out=128*2)
#         self.RS_Up_conv4 = conv_block(ch_in=int(256/2) + 128*4*2, ch_out=128*2)
#         self.RS_Up3 = up_conv(ch_in=128*2, ch_out=64*2)
#         self.RS_Up_conv3 = conv_block(ch_in=int(128/2) + 64*4*2, ch_out=64*2)
#         self.RS_Up2 = up_conv(ch_in=64*2, ch_out=32*2)
#         self.RS_Up_conv2 = conv_block(ch_in=int(64/2) + 32*4*2, ch_out=64)
...
#         self.S_Conv1 = conv_block(ch_in=in_channels, ch_out=32*2)
#         self.S_Conv2 = conv_block(ch_in=32*2, ch_out=64*2)
#         self.S_Conv3 = conv_block(ch_in=64*2, ch_out=128*2)
#         self.S_Conv4 = conv_block(ch_in=128*2, ch_out=256*2)
#         self.S_Conv5 = conv_block(ch_in=256*2, ch_out=512*2)
...
#         self.M_Conv1 = conv_block(ch_in=in_channels * 2, ch_out=int(64/2))
#         self.M_Conv2 = conv_block(ch_in=int(64/2), ch_out=int(128/2))
#         self.M_Conv3 = conv_block(ch_in=int(128/2), ch_out=int(256/2))
#         self.M_Conv4 = conv_block(ch_in=int(256/2), ch_out=int(512/2))
#         self.M_Conv5 = conv_block(ch_in=int(512/2), ch_out=int(1024/2))
#         # self.M_top = conv_block(ch_in=1024, ch_out=1024)

#         self.M_Up5 = up_conv(ch_in=int(1024/2), ch_out=int(512/2))
#         self.RSM_Up_conv5 = conv_block(ch_in=int(512*2/2) + 256*2, ch_out=int(512/2))
#         self.RSM_Up4 = up_conv(ch_in=int(512/2), ch_out=int(256/2))
#         self.RSM_Up_conv4 = conv_block(ch_in=int(256*2/2) + 128*2, ch_out=int(256/2))
#         self.RSM_Up3 = up_conv(ch_in=int(256/2), ch_out=int(128/2))
#         self.RSM_Up_conv3 = conv_block(ch_in=int(128*2/2) + 64*2, ch_out=int(128/2))
#         self.RSM_Up2 = up_conv(ch_in=int(128/2), ch_out=int(64/2))
#         self.RSM_Up_conv2 = conv_block(ch_in=int(64*2/2) + 32*2, ch_out=64)
#         self.RSM_Conv_1x1 = nn.Conv2d(64, num_classes, kernel_size=1, stride=1, padding=0)

#         # fusion
#         self.fusion_RS1 = Fusion_Attention_M2(32*2, 32*2) 
#         # self.fusion_RSM1 = Fusion_Attention_M1(64, 64) 
#         self.fusion_RS2 = Fusion_Attention_M2(64*2, 64*2)
#         # self.fusion_RSM2 = Fusion_Attention_M1(128, 128)
#         self.fusion_RS3 = Fusion_Attention_M2(128*2, 128*2)
#         # self.fusion_RSM3 = Fusion_Attention_M1(256, 256)
#         self.fusion_RS4 = Fusion_Attention_M2(256*2, 256*2)
#         # self.fusion_RSM4 = Fusion_Attention_M1(512, 512)
#         self.fusion_RS5 = Fusion_Attention_M2(512*2, 512*2)
...
#         self.RS_Up_conv5 = conv_block(ch_in=int(512/2) + 256*4, ch_out=256)
#         self.RS_Up4 = up_conv(ch_in=256, ch_out=128)
#         self.RS_Up_conv4 = conv_block(ch_in=int(256/2) + 128*4, ch_out=128)
#         self.RS_Up3 = up_conv(ch_in=128, ch_out=64)
#         self.RS_Up_conv3 = conv_block(ch_in=int(128/2) + 64*4, ch_out=64)
#         self.RS_Up2 = up_conv(ch_in=64, ch_out=32)
#         self.RS_Up_conv2 = conv_block(ch_in=int(64/2) + 32*4, ch_out=64)
#         self.RS_Conv_1x1 = nn.Conv2d(64, num_classes, kernel_size=1, stride=1, padding=0)
...
#         self.M_Up5 = up_conv(ch_in=int(1024/2), ch_out=int(512/2))
#         self.RSM_Up_conv5 = conv_block(ch_in=int(512*2/2) + 256, ch_out=int(512/2))
#         self.RSM_Up4 = up_conv(ch_in=int(512/2), ch_out=int(256/2))
#         self.RSM_Up_conv4 = conv_block(ch_in=int(256*2/2) + 128, ch_out=int(256/2))
#         self.RSM_Up3 = up_conv(ch_in=int(256/2), ch_out=int(128/2))
#         self.RSM_Up_conv3 = conv_block(ch_in=int(128*2/2) + 64, ch_out=int(128/2))
#         self.RSM_Up2 = up_conv(ch_in=int(128/2), ch_out=int(64/2))
#         self.RSM_Up_conv2 = conv_block(ch_in=int(64*2/2) + 32, ch_out=64)
#         self.RSM_Conv_1x1 = nn.Conv2d(64, num_classes, kernel_size=1, stride=1, padding=0)
...
#         self.RS_Up5 = up_conv(ch_in=512*2, ch_out=256*2)
#         self.RS_Up_conv5 = conv_block(ch_in=512 + 256*4*2, ch_out=256*2)
#         self.RS_Up4 = up_conv(ch_in=256*2, ch_out=128*2)
#         self.RS_Up_conv4 = conv_block(ch_in=256 + 128*4*2, ch_out=128*2)
#         self.RS_Up3 = up_conv(ch_in=128*2, ch_out=64*2)
#         self.RS_Up_conv3 = conv_block(ch_in=128 + 64*4*2, ch_out=64*2)
#         self.RS_Up2 = up_conv(ch_in=64*2, ch_out=32*2)
#         self.RS_Up_conv2 = conv_block(ch_in=64 + 32*4*2, ch_out=64)
#         self.RS_Conv_1x1 = nn.Conv2d(64, num_classes, kernel_size=1, stride=1, padding=0)
...
#         self.RSM_Up_conv5 = conv_block(ch_in=512*2 + 256*2, ch_out=512)
#         self.RSM_Up4 = up_conv(ch_in=512, ch_out=256)
#         self.RSM_Up_conv4 = conv_block(ch_in=256*2 + 128*2, ch_out=256)
#         self.RSM_Up3 = up_conv(ch_in=256, ch_out=128)
#         self.RSM_Up_conv3 = conv_block(ch_in=128*2 + 64*2, ch_out=128)
#         self.RSM_Up2 = up_conv(ch_in=128, ch_out=64)
#         self.RSM_Up_conv2 = conv_block(ch_in=64*2 + 32*2, ch_out=64)
#         self.RSM_Conv_1x1 = nn.Conv2d(64, num_classes, kernel_size=1, stride=1, padding=0)
...
#         # Raw network
#         self.R_Maxpool = nn.MaxPool2d(kernel_size=2, stride=2)
#         self.R_Conv1 = conv_block(ch_in=in_channels, ch_out=32, dropout_p=0.05)
#         self.R_Conv2 = conv_block(ch_in=32, ch_out=64, dropout_p=0.1)
#         self.R_Conv3 = conv_block(ch_in=64, ch_out=128, dropout_p=0.2)
#         self.R_Conv4 = conv_block(ch_in=128, ch_out=256, dropout_p=0.3)
...
#         self.RS_Up3 = up_conv(ch_in=128, ch_out=64)
#         self.RS_Up_conv3 = conv_block(ch_in=128 + 64*4, ch_out=64, dropout_p=0.0)
#         self.RS_Up2 = up_conv(ch_in=64, ch_out=32)
#         self.RS_Up_conv2 = conv_block(ch_in=64 + 32*3, ch_out=64, dropout_p=0.0)
#         self.RS_Conv_1x1 = nn.Conv2d(64, num_classes, kernel_size=1, stride=1, padding=0)

#         # Select network
#         self.S_Maxpool = nn.MaxPool2d(kernel_size=2, stride=2)
#         self.S_Conv1 = conv_block(ch_in=in_channels, ch_out=32, dropout_p=0.05)
#         self.S_Conv2 = conv_block(ch_in=32, ch_out=64, dropout_p=0.1)
#         self.S_Conv3 = conv_block(ch_in=64, ch_out=128, dropout_p=0.2)
#         self.S_Conv4 = conv_block(ch_in=128, ch_out=256, dropout_p=0.3)
#         self.S_Conv5 = conv_block(ch_in=256, ch_out=512, dropout_p=0.5)
...
#         self.M_Conv5 = conv_block(ch_in=512, ch_out=1024, dropout_p=0.5)
#         # self.M_top = conv_block(ch_in=1024, ch_out=1024)

#         self.M_Up5 = up_conv(ch_in=1024, ch_out=512)
#         self.RSM_Up_conv5 = conv_block(ch_in=512*2 + 256, ch_out=512, dropout_p=0.0) #  + 256
#         self.RSM_Up4 = up_conv(ch_in=512, ch_out=256)
#         self.RSM_Up_conv4 = conv_block(ch_in=256*2 + 128, ch_out=256, dropout_p=0.0) #  + 128
#         self.RSM_Up3 = up_conv(ch_in=256, ch_out=128)
#         self.RSM_Up_conv3 = conv_block(ch_in=128*2 + 64, ch_out=128, dropout_p=0.0) #  + 64
#         self.RSM_Up2 = up_conv(ch_in=128, ch_out=64)
#         self.RSM_Up_conv2 = conv_block(ch_in=64*2, ch_out=64, dropout_p=0.0) #  + 32
#         self.RSM_Conv_1x1 = nn.Conv2d(64, num_classes, kernel_size=1, stride=1, padding=0)
...
#         RS_d2 = self.RS_Up2(RS_d3)
#         RS_d2 = torch.cat((R_x1, S_x1, RS_d2, M_x1), dim=1)  # R_x1, S_x1, RS_d2, RS_x1, M_x1
#         RS_d2 = self.RS_Up_conv2(RS_d2)
...
#         RSM_d2 = self.RSM_Up2(RSM_d3)
#         RSM_d2 = torch.cat((M_x1, RSM_d2), dim=1)
#         RSM_d2 = self.RSM_Up_conv2(RSM_d2)
