...
#     def __init__(self, in_channels=1, output_channels=3, init_features=16):
...
class MFwaveNet2_3D(nn.Module):
    def __init__(self, in_channels=1, output_channels=3, init_features=16):  # 我好像应该是12的，而不是24
        super(MFwaveNet2_3D, self).__init__()
        self.features = init_features
